...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'x86_64-alpine-linux-musl',
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
           '-Os -fomit-frame-pointer -g -O2 -Os -fomit-frame-pointer -g -O2 '
           '-Os -fomit-frame-pointer -g -O2 -DTHREAD_STACK_SIZE=0x100000',
 'CFLAGSFORSHARED': '-fPIC',
 'CFLAGS_ALIASING': '',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-Os -fomit-frame-pointer -g -O2',
 'CONFIGURE_CFLAGS_NODIST': '-fno-semantic-interposition -flto '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-Os -fomit-frame-pointer -O2',
 ...
 'CONFIG_ARGS': "'--build=x86_64-alpine-linux-musl' "
                ...
                "'LDFLAGS=-Wl,--as-needed,-O1,--sort-common' 'CPPFLAGS=-Os "
                "-fomit-frame-pointer -O2'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.10',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/buildozer/aports/main/python3/src/Python-3.10.11/coverage.info',
 'COVERAGE_REPORT': '/home/buildozer/aports/main/python3/src/Python-3.10.11/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include -Os -fomit-frame-pointer -O2 -Os '
             '-fomit-frame-pointer -O2',
 'CXX': 'g++',
 ...
 'HAVE_ZLIB_COPY': 1,
 'HAVE__GETPTY': 0,
 'HOST_GNU_TYPE': 'x86_64-alpine-linux-musl',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g '
                             '-fwrapv -O3 -Wall -Os -fomit-frame-pointer -g '
                             '-O2 -Os -fomit-frame-pointer -g -O2 -Os '
                             '-fomit-frame-pointer -g -O2 '
                             ...
                             '-I./Include -Os -fomit-frame-pointer -O2 -Os '
                             '-fomit-frame-pointer -O2 -fPIC '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   '-Wall -Os -fomit-frame-pointer -g -O2 -Os '
                   '-fomit-frame-pointer -g -O2 -Os -fomit-frame-pointer -g '
                   ...
                   '-I. -I./Include -Os -fomit-frame-pointer -O2 -Os '
                   '-fomit-frame-pointer -O2 -fPIC -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-Wl,--as-needed,-O1,--sort-common '
                    '-Wl,--as-needed,-O1,--sort-common '
                    '-fno-semantic-interposition -flto -fuse-linker-plugin '
                    '-ffat-lto-objects -flto-partition=none -g',
 'PY_CPPFLAGS': '-I. -I./Include -Os -fomit-frame-pointer -O2 -Os '
                '-fomit-frame-pointer -O2',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 ...
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv '
                        '-O3 -Wall -Os -fomit-frame-pointer -g -O2 -Os '
                        '-fomit-frame-pointer -g -O2 -Os -fomit-frame-pointer '
                        '-g -O2 -DTHREAD_STACK_SIZE=0x100000 '
                        '-fno-semantic-interposition -flto -fuse-linker-plugin '
                        '-ffat-lto-objects -flto-partition=none -g -std=c99 '
                        '-Wextra -Wno-unused-result -Wno-unused-parameter '
                        '-Wno-missing-field-initializers -Wstrict-prototypes '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.10.11',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 'SHLIBS': '-ldl  -lm',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.10.11 '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.10.11 '
 ...
 'abs_builddir': '/home/buildozer/aports/main/python3/src/Python-3.10.11',
 'abs_srcdir': '/home/buildozer/aports/main/python3/src/Python-3.10.11',
